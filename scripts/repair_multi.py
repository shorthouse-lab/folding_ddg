...
pdbfile = sys.argv[1]
repairnumber = 10
foldx_location = "~/Documents/foldx5MacC11/foldx_20241231 "
pdbfile_base = pdbfile.split(".")[0]

# do first repair
foldx_repair1 = foldx_location + " --command=RepairPDB --pdb=" + pdbfile + " --water=CRYSTAL"
os.system(foldx_repair1) 

for i in range(0,repairnumber-1):
    foldx_repair2 = foldx_location + " --command=RepairPDB --pdb=" + pdbfile_base + "_Repair.pdb --water=CRYSTAL"
