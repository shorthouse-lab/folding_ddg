...
pdbfile = sys.argv[1]
foldx_location = "/Users/davidshorthouse/Documents/foldx5MacC11/"
residuelist = []
...
foldx_positionscan = foldx_location +"foldx_20241231 --command=PositionScan --pdb=" +pdbfile + " --position=" + ",".join(residuelist)
